...
qq.FileUploader = function(o){
    ...
    qq.extend(this._options, {
        ...
        template: '<div class="qq-uploader">' +
            ...
            //+'<div class="btn btn-primary" id="triggerUpload" style="float:right">Upload Files</div>'
            ,
        ...
        fileTemplate: '<li>' +
            ...
            '<span class="qq-upload-finished">success!</span>' +
            '<a class="qq-upload-cancel close" href="#">×</a>' +
            '<div class="progress"><div class="qq-progress-bar bar"></div></div>' +
